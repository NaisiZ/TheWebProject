...
<div class="container-fluid">
	...
	<div class="row">
		...
		<div class="col-sm-offset-1 col-sm-6">
			...
			<h3>Industrial Shoe Box</h3>
			<div class="row">
				<div class="col-md-6 col-sm-6">
					<!-- C1 -->
					<p class="text-left">
						<a href="<?php echo $_SESSION['www']; ?>products/product_details.php?pn=MPC-1060">
							<span class="prod_name">MPC-1060</span>
						</a><br />
						6-Slot
					</p>
					<p class="text-left">
						<a href="<?php echo $_SESSION['www']; ?>products/product_details.php?pn=MPC-1061">
							<span class="prod_name">MPC-1061</span>
						</a><br />
						6-Slot
					</p>
				</div>
